...
faqs:
 ...
 - q: "What happens if I can't find homeowner insurance in Florida at all?"
   a: "Citizens Property Insurance Corporation is your fallback option if you've been denied coverage by the private market. You'll need documentation showing you've been rejected or quoted premiums above Citizens' rates. Working with an independent insurance agent who writes both Citizens and private market coverage can help you navigate this."
 - q: "Do I need to buy flood insurance even if I'm not in a flood zone?"
...
**Flood is not covered.** This is the single most dangerous assumption homeowners make. Standard homeowner insurance does not cover flood damage, period. In Florida, where even a moderate rainstorm can overwhelm drainage systems and where storm surge can inundate neighborhoods miles from the beach, this gap can be catastrophic. Flood coverage must be purchased separately, usually through the National Flood Insurance Program (NFIP) or a private flood insurer. The NFIP has coverage limits of $250,000 for structure and $100,000 for contents, which may not be enough if you own a higher-value home.
...
## Citizens Insurance: The Safety Net That Comes With Strings

If you've been depopulated, received a takeout offer, or are considering Citizens for the first time, here's what you need to understand.

Citizens Property Insurance Corporation was designed as a last resort, not a first choice. Florida law requires that if a private insurer offers you coverage within 20% of what Citizens charges, you're ineligible for Citizens. That eligibility threshold matters because Citizens rates have been increasing as the state works to bring them closer to actuarially sound levels.

Here's the string people often miss: Citizens policyholders can be assessed if Citizens doesn't have enough funds to pay claims after a major storm. That assessment can apply to your policy for multiple years. It's rare, but it's real, and it's in the policy language.

Citizens also has coverage limits. As of recent policy years, Citizens won't insure homes valued above $700,000 in most areas (the threshold differs slightly for coastal properties). If your home's replacement cost exceeds that, you'll need to find private market coverage or use a combination approach.

If you receive a "takeout" letter saying a private insurer wants to assume your Citizens policy, don't automatically decline it. Compare the coverage carefully, not just the premium. Sometimes the private policy is actually better structured. Sometimes it's not. The [National Association of Insurance Commissioners (NAIC)](https://www.naic.org/) offers consumer resources that can help you understand what to compare.

## How to Actually Read Your Policy Before It's Too Late

Most people don't open their policy until after a loss. I understand why. It's dense, it's technical, and nothing about it feels urgent when the sky is blue. But in Florida, where a storm can shift from a named storm to a direct hit in 48 hours, not knowing your policy terms before you file a claim puts you at a real disadvantage.

Here's a practical step-by-step approach to reviewing your policy now, while you still have time to make changes.

**Step 1: Find your declarations page.** This is the summary page, usually one to two pages long, that lists your coverage amounts, deductibles, and any endorsements. Pull it up right now.

**Step 2: Write down your hurricane deductible percentage and calculate the dollar amount.** Take your dwelling coverage amount and multiply it by your hurricane deductible percentage. That number is your worst-case out-of-pocket exposure before coverage kicks in for a named storm.

**Step 3: Check your roof coverage terms.** Look for language about actual cash value, cosmetic damage exclusions, or age-related limitations. If you're not sure what you're reading, call your agent and ask directly: "If I need a full roof replacement after a hurricane, will my policy pay replacement cost or actual cash value, and is there any limitation based on my roof's age?"

**Step 4: Confirm you have separate flood coverage.** If you're not sure, you don't. Flood coverage would be a separate policy with a separate premium and a separate declarations page.

**Step 5: Create a home inventory.** This is critical for personal property claims. A video walkthrough stored in the cloud works well. There are also dedicated home inventory apps that let you catalog items by room and attach photos and receipts. Keeping a copy of your inventory, and your policy documents, in a fireproof document safe [(like this one on Amazon, and yes, we may earn a small commission)](https://www.amazon.com/s?k=fireproof+document+safe) means you'll have access to them even if the home is damaged.

**Step 6: Check your loss of use coverage.** This is the amount your policy will pay for temporary housing, meals, and related expenses if your home is uninhabitable. Make sure it's enough to cover realistic hotel or rental costs in your area for several months.

## Practical Ways to Lower Your Premium Without Gutting Your Coverage
...
Bundling home and auto with the same insurer sometimes produces discounts, though the savings vary widely.

If you haven't had a 4-point inspection (which evaluates your roof, electrical, plumbing, and HVAC systems) in the last few years, consider getting one. Some insurers require it for older homes, but it can also reveal deferred maintenance issues that would cause a claim denial if left unaddressed.
