...
faqs:
  - q: "Can I just add my rental property to my existing homeowners policy?"
    a: "No. A homeowners policy insures an owner-occupied primary or secondary residence. A property you rent to tenants full-time requires a separate landlord policy (DP-3). Adding the rental property address to your homeowners policy won't create valid coverage for it, and if you file a claim without proper disclosure, the insurer can deny it."
  - q: "What's the difference between a DP-1, DP-2, and DP-3 policy?"
    a: "These are three tiers of dwelling fire policies. A DP-1 is the most basic, covering only named perils like fire, lightning, and internal explosion. A DP-2 adds more named perils. A DP-3 is open-peril, meaning it covers all causes of loss except those specifically excluded, which gives you much broader protection. For a property that represents a significant financial asset, DP-3 is almost always the right choice."
  - q: "Does landlord insurance cover my tenants' belongings?"
    a: "No. Your landlord policy covers the structure and your own property within it (like appliances you own). Tenants' personal belongings are their responsibility. That's exactly why encouraging or requiring tenants to get renters insurance is in everyone's interest. The home insurance vs renters insurance comparison explains what each policy covers and why they're designed to work together."
...
Let's be direct about something. Standard landlord insurance does not cover malicious or intentional tenant damage in most cases. If a tenant punches holes in the walls, destroys the carpet, and breaks fixtures before leaving, you're generally filing in small claims court against the security deposit, not filing an insurance claim.
...
Not all rental situations are identical. Here's a practical breakdown:

| Situation | Recommended Policy |
|---|---|
| Primary home, renting a room | HO-3 with landlord endorsement |
| Occasional short-term rental (Airbnb, VRBO) | HO-3 with home-sharing endorsement, or standalone STR policy |
| Full-time rental, you don't live there | DP-3 landlord policy |
| Vacant property (between tenants or renovating) | Vacant home policy (separate product) |
...
This is where I've seen some of the most damaging mistakes. Landlords set their dwelling coverage based on what they paid for the property, or worse, what they owe on the mortgage, rather than what it would cost to rebuild from the ground up.

Purchase price and replacement cost are two different numbers. In many markets right now, reconstruction costs per square foot have increased significantly over the past several years due to labor and material inflation. If you insured your rental property three years ago and haven't reviewed the coverage since, you may be significantly underinsured.
...
2. **Get a landlord-specific policy (DP-3) if you're renting full-time.** Tell the insurer the property is tenant-occupied. Disclose accurately. Misrepresenting occupancy to get a lower rate is the fastest path to a denied claim.

3. **Set dwelling coverage at full replacement cost, not market value or loan balance.** Get a replacement cost estimate from your insurer or a local contractor if the property has unusual features.

4. **Choose replacement cost value (RCV) over actual cash value (ACV)** for the dwelling, and ask about RCV for any personal property coverage too.

5. **Add loss of rental income coverage** if it's not automatic on the base policy. Confirm how many months it covers and what the monthly benefit cap is.

6. **Ask specifically about tenant vandalism coverage** and whether it's included or available as an endorsement.
