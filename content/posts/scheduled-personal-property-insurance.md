...
slug: "scheduled-personal-property-insurance"
affiliate_disclosure: true
faqs:
  - q: "What's the difference between a floater and a rider?"
    a: "In practice, most insurers use these terms interchangeably for scheduled personal property coverage. Technically, a 'rider' is an amendment to an existing policy, while a 'floater' can be a standalone policy, but you'll hear both used to mean the same thing."
  - q: "Do I need a floater if I already have replacement cost coverage on my homeowners policy?"
    a: "Yes, and this is a common misunderstanding. Replacement cost coverage on your base policy still applies subject to the policy's sublimits for specific categories like jewelry or electronics. Replacement cost doesn't eliminate sublimits; it only removes depreciation from the calculation for items that are actually covered."
  - q: "Can renters get scheduled personal property coverage?"
    a: "Absolutely. Renters policies have the same sublimit structure as homeowners policies, and floaters can be added to renters coverage just as easily. If you rent and own anything valuable, this matters just as much to you as to a homeowner."
  - q: "Will filing a floater claim raise my homeowners premium?"
...
Musical instruments are another one I'd flag specifically. A decent violin or cello can cost anywhere from $5,000 to well over $100,000, and most people treat them like furniture when insuring them. Standard policies often don't even cover accidental breakage (dropping it, cracking the body during travel) unless you've scheduled it and specifically added that peril. The National Association of Insurance Commissioners has published consumer guidance on floaters worth reading before you renew, available at [naic.org](https://www.naic.org/).
...
Step 4: Compare. Standalone jewelry or fine art floaters from specialty insurers (I won't name names, but you can find them through your state's insurance department directory at [naic.org/state_web_map.htm](https://www.naic.org/state_web_map.htm)) sometimes offer broader terms or lower premiums than adding a rider to a mass-market homeowners policy.
...
- [National Association of Insurance Commissioners (NAIC)](https://www.naic.org/): Consumer guidance on personal property floaters and homeowners policy sublimits
- [Insurance Information Institute (Triple-I)](https://www.iii.org/): Industry data on homeowners policy structures and personal property coverage options
- [American Society of Appraisers](https://www.appraisers.org/): Standards for personal property appraisals used in insurance scheduling
- [GIA (Gemological Institute of America)](https://www.gia.edu/): Gemstone grading reports used in jewelry valuation for insurance purposes
- [NAIC Consumer's Guide to Homeowners Insurance](https://content.naic.org/sites/default/files/publication-hoi-lp-homeowners-insurance-guide.pdf): Plain-language guide to policy types, sublimits, and endorsements (current as of 2026 guidance cycle)
