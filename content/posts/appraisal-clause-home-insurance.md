...
slug: "appraisal-clause-home-insurance"
affiliate_disclosure: true
faqs:
  - q: "Does the appraisal clause apply to all types of homeowner claims?"
    a: "Generally yes, for disputes about the dollar amount of a covered loss. It typically applies to fire, wind, hail, and water damage claims. It doesn't apply to coverage disputes (where the insurer says the loss isn't covered at all) or liability claims."
  - q: "Can I invoke the appraisal clause after I've already accepted a partial payment?"
    a: "Accepting a partial payment doesn't automatically waive your right to invoke appraisal, but cashing a check marked 'final settlement' might. Read any language on the check or accompanying paperwork very carefully before signing or depositing anything."
  - q: "How long does the appraisal process take?"
    a: "Typically 8 to 16 weeks from demand to award, though complex claims or disputes over the umpire selection can stretch it longer. It's faster than litigation, but not fast."
  - q: "What if I disagree with the appraisal award?"
...
The process only addresses the amount of loss. If your insurer is denying coverage entirely, the appraisal clause doesn't help you. That's a coverage dispute, and you'd need arbitration, litigation, or your state's insurance department complaint process instead. The [NAIC's state insurance department directory](https://www.naic.org/state_web_map.htm) is the fastest way to find who regulates your insurer if you're not sure which direction to go.
...
**Step 3.** Select your appraiser carefully. Look for someone with documented experience in residential property appraisal disputes, not just general contracting. The [IBHS](https://ibhs.org/) doesn't credential appraisers directly, but their technical guides on building science are useful for briefing your appraiser on what good-faith repair estimates should include.
...
- [NAIC (National Association of Insurance Commissioners)](https://www.naic.org): Regulatory body coordinating state insurance oversight; the state directory is the definitive resource for finding your state's insurance department.
...
- [Insurance Research Council (IRC)](https://www.insurance-research.org): Publishes periodic studies on claims disputes, settlement patterns, and policyholder behavior.
- [IBHS (Insurance Institute for Business and Home Safety)](https://ibhs.org/): Produces technical research on building resilience and repair standards relevant to loss valuation.
