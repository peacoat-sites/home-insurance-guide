---
title: "FAIR Plan Insurance: Your Last Resort Home Coverage Option"
...
slug: "fair-plan-insurance-explained"
...
I want to be direct here because this is where real financial harm happens.
...
The IBHS (Insurance Institute for Business & Home Safety) publishes home fortification guides at [ibhs.org](https://ibhs.org/) that are worth reading here, because one underappreciated fact is that hardening your home against its specific risk (wildfire, wind, hail) can sometimes make it insurable in the private market again. New roof, ember-resistant vents, cleared defensible space. These aren't guarantees, but I've seen homeowners improve their insurability enough to exit the residual market after making targeted upgrades.

Once you're in a FAIR plan, the questions to ask are:

What exactly does this policy cover? Get the declarations page and read it. Don't assume.
Is personal property included or is that a separate endorsement?
Is liability included?
What perils are covered? Many FAIR plans cover fire and a named subset of perils, not "open perils" like a standard HO-3 policy.
What's the process if the insurer of last resort becomes insolvent? (Florida's Citizens situation has made this a real question worth asking.)
...
- [National Association of Insurance Commissioners (NAIC)](https://www.naic.org/): State-by-state FAIR plan program documentation and consumer guides
- [California FAIR Plan Association](https://www.cfpnet.com/): Current policy data and coverage details for California's residual market program
- [Insurance Institute for Business & Home Safety (IBHS)](https://ibhs.org/): Home fortification research and wildfire/wind mitigation guides
- [Citizens Property Insurance Corporation](https://www.citizensfla.com/): Florida's state-backed insurer of last resort, policy and enrollment data
- [Insurance Information Institute (Triple-I)](https://www.iii.org/): Industry data on residual market growth and homeowner insurance availability trends
