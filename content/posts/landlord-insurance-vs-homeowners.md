...
Here's the thing I'd push back on if you told me "my agent handles all that": agents make mistakes, and the burden of having correct coverage ultimately lands on you.
...
The [National Association of Insurance Commissioners (NAIC)](https://www.naic.org/) maintains good state-by-state guidance on what landlord policies must include versus what's optional. It's dry reading, but if you're insuring a rental for the first time, spending 20 minutes with your state's resources via the [NAIC's state insurance department directory](https://www.naic.org/state_web_map.htm) can tell you what minimum coverage requirements apply in your area.
