...
faqs:
  - q: "Does my spouse automatically get added to my homeowners policy when we get married?"
    a: "No. Marriage doesn't automatically update your policy. You need to contact your insurer and explicitly add your spouse as a named insured. Don't assume it happened; confirm it in writing."
  - q: "Will combining households raise my homeowners insurance premium?"
    a: "Possibly, but not dramatically for most couples. Adding a spouse and updating your personal property coverage limit may nudge your premium up slightly. Bundling discounts and improved credit profiles (some insurers use credit scores as a rating factor) can offset that. It varies by insurer and your state's regulatory environment."
  - q: "What happens to my spouse's renters insurance when they move into my home?"
    a: "Cancel it once they've fully moved out of the old rental. Their belongings are now covered under the shared homeowners policy, assuming you've added them as a named insured. Paying for both simultaneously is just waste."
  - q: "Do we need separate policies if we own two properties?"
...
Here's the problem: most people treat homeowners insurance like a set-it-and-forget-it utility. You get it when you buy the house, you pay it automatically, and you don't think about it again until something breaks. Marriage breaks that pattern in ways your insurer won't call to explain.

## What Actually Changes When You Merge Households

The most immediate issue is property. When two people combine households, personal property coverage suddenly has to stretch over twice the stuff, sometimes more. Most standard HO-3 policies cover personal belongings at somewhere between 50% and 70% of your dwelling coverage limit. That sounds generous until you actually inventory what two adults own: electronics, furniture, clothing, jewelry, tools, sporting equipment. It adds up faster than you'd expect.

If one spouse moves into the other's home, their belongings aren't automatically covered just because they're now physically present. Coverage follows the named insured on the policy. A spouse who isn't listed may have some protection under certain policy language, but "some protection" isn't a number you want to rely on after a fire. The fix is straightforward: contact your insurer, add your spouse as a named insured, and request a coverage review at the same time.

What most agents won't proactively tell you: this is also the moment to request a full replacement cost estimate on your combined personal property. Most couples do this and find they're underinsured by $20,000 to $40,000 or more.
...
Marriage is a genuinely good trigger point to buy a personal umbrella policy if you don't already have one. A $1 million umbrella typically runs $150 to $300 per year. That's not nothing, but it's a fraction of what you'd spend defending a serious liability claim. I'd call this the most underused coverage most homeowners have never heard of.

Also worth checking: does your combined household now include any new attractive nuisances? A trampoline one spouse brought from their old place, a pool that's now being used by a larger social circle, a dog breed your insurer might categorize as high-risk? All of these can affect your coverage and potentially your rates, and your insurer needs to know about them.

## Jewelry, Art, and the Engagement Ring Problem

Standard personal property coverage caps payouts on certain categories of valuables regardless of your overall limit. Jewelry is typically capped at $1,000 to $2,500 for theft, sometimes less. If your engagement ring cost $6,000, your base policy isn't covering the gap.
...
Wedding gifts deserve a mention here too. If your household just received $15,000 in new stuff over the course of several months, that changes your personal property exposure. Update your coverage before the gifts arrive, not after.
...
For most couples moving into one shared residence, the answer is one policy on the shared home, with both spouses named. Renters insurance from a previous apartment gets cancelled once you've moved out. Straightforward.
...
A rented property needs a landlord policy (sometimes called a dwelling fire policy), not a homeowners policy. Your insurer can explain the difference, but so can your state's insurance department, which publishes consumer guides that are actually readable.

## The Bundling Question

Insurance companies will push hard for you to bundle home and auto after marriage, especially if you're combining two auto policies onto one insurer. Bundling discounts are real, sometimes 10% to 15%, but they don't automatically mean you're getting the best deal. Run the comparison. The [National Association of Insurance Commissioners (NAIC)](https://www.naic.org/) has a consumer information portal where you can research complaint ratios for insurers in your state, which tells you something about what it's actually like to file a claim with them.

Discounts for newly married couples vary by insurer and state. Some companies offer them explicitly. Others just reprice your profile when they see a name change or address change. It's worth asking your agent directly: "Is there a discount for adding a spouse?" The answer won't always be yes, but the question costs nothing.
