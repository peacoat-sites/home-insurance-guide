---
title: "Dwelling Fire Policy: 2 Coverage Types That Matter"
date: 2026-07-11T10:51:02.741331+00:00
draft: false
description: "A dwelling fire policy explained clearly: what it covers, 15+ key terms, 40 perils, and why $28,000 in damage claims can hinge on your form type."
image: "/img/heroes/32381697.jpg"
categories: ["Property Types"]
tags: ["dwelling", "fire", "policy", "explained"]
author: "Carl Brooks"
...
slug: "dwelling-fire-policy-explained"
affiliate_disclosure: true
faqs:
  - q: "Can a dwelling fire policy cover a home I live in part-time?"
    a: "Yes, in some cases. If you occupy the home seasonally but also rent it out, a DP-3 with appropriate endorsements can work. You'll need to be upfront with the carrier about the occupancy pattern, because misrepresenting it can void the policy at claim time. Some carriers will require a seasonal/secondary home policy instead."
  - q: "Does a dwelling fire policy cover the tenant's belongings?"
    a: "No. A DP policy covers the structure and, if endorsed, the landlord's personal property used to service the rental (appliances, for example). The tenant's furniture, electronics, and clothing are the tenant's responsibility. Requiring renter's insurance as a lease condition is one of the simplest things a landlord can do to reduce disputes after a loss."
  - q: "What's the difference between ACV and replacement cost in a dwelling claim?"
    a: "Actual cash value (ACV) means the insurer subtracts depreciation based on the age and condition of the damaged item before writing your check. Replacement cost value (RCV) means they pay what it actually costs to repair or replace with new materials, without a depreciation deduction. On older properties, the gap can be tens of thousands of dollars."
  - q: "Is flood ever covered under a dwelling fire policy?"
    a: "No. Flood is excluded under all DP forms. If your rental is in a flood zone (check FEMA's flood map service), you need a separate National Flood Insurance Program (NFIP) policy or a private flood policy. Some landlords in inland areas skip this and regret it after a heavy rain event backs up into the basement."
  - q: "Does a DP policy cover me if a tenant sues me for a habitability issue?"
    a: "Only if your policy includes a liability endorsement and only if the claim falls within the covered liability triggers. Disputes over habitability, mold, or failure to maintain the property can create liability exposure that some DP liability endorsements exclude. Read the exclusions section carefully or ask your agent to walk you through it specifically."
---
...
The Insurance Information Institute notes that DP policies are among the most misunderstood products in personal lines insurance, largely because the market has three distinct forms (DP-1, DP-2, DP-3) that sound similar but behave very differently at claim time. Your state's insurance department (find yours through the [NAIC's state map](https://www.naic.org/state_web_map.htm)) can tell you which forms are approved in your state and what minimum coverage standards apply.
...
Here's where I want to slow down, because this is where people get hurt.
...
<style>.stat-chart{margin:28px 0;padding:18px 20px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)}.stat-chart .sc-title{font-weight:700;margin-bottom:12px;color:var(--heading,#1e293b)}.stat-chart .sc-row{display:flex;align-items:center;gap:10px;margin:7px 0}.stat-chart .sc-label{flex:0 0 34%;font-size:.85rem;color:var(--muted,#475569);text-align:right;overflow-wrap:anywhere}.stat-chart .sc-track{flex:1;background:var(--border,#e7e5e4);border-radius:6px;height:14px;overflow:hidden}.stat-chart .sc-bar{display:block;height:100%;background:var(--accent,#4338ca);border-radius:6px}.stat-chart .sc-val{flex:0 0 auto;font-size:.82rem;font-weight:600;color:var(--heading,#1e293b);min-width:56px}.stat-chart .sc-src{margin-top:10px;font-size:.75rem;color:var(--muted,#64748b)}@media(max-width:560px){.stat-chart .sc-label{flex-basis:42%}}</style><div class="stat-chart"><div class="sc-title">Average Dwelling Fire Claim Payout by Loss Type</div><div class="sc-row"><span class="sc-label">Fire &amp; Lightning</span><span class="sc-track"><span class="sc-bar" style="width:100%"></span></span><span class="sc-val">$84,200</span></div><div class="sc-row"><span class="sc-label">Wind &amp; Hail</span><span class="sc-track"><span class="sc-bar" style="width:15%"></span></span><span class="sc-val">$12,800</span></div><div class="sc-row"><span class="sc-label">Water &amp; Freezing</span><span class="sc-track"><span class="sc-bar" style="width:13%"></span></span><span class="sc-val">$11,000</span></div><div class="sc-row"><span class="sc-label">Theft</span><span class="sc-track"><span class="sc-bar" style="width:5%"></span></span><span class="sc-val">$4,300</span></div><div class="sc-row"><span class="sc-label">Liability (DP+rider)</span><span class="sc-track"><span class="sc-bar" style="width:34%"></span></span><span class="sc-val">$28,600</span></div><div class="sc-src">Source: III Industry Data / ISO Dwelling Program Estimates, 2025</div></div>
...
If you've got multiple rentals, it's worth maintaining a home inventory with documentation stored somewhere fireproof. A [fireproof document safe](https://www.amazon.com/s?k=fireproof+document+safe&tag=yourtag-20) (note: this site may earn a commission on Amazon purchases) can protect policy documents, purchase records, and renovation receipts that become critical if you're negotiating an ACV claim. Same logic applies to [water leak sensors](https://www.amazon.com/s?k=water+leak+sensor&tag=yourtag-20) in basements or near water heaters: caught early, a plumbing failure is a $400 repair. Missed for three weeks, it's a DP-1 claim that doesn't cover the mold remediation that follows.

## Sources

- [Insurance Information Institute (III)](https://www.iii.org/): Industry loss data, policy type descriptions, and homeowner/dwelling insurance statistics
- [National Association of Insurance Commissioners (NAIC)](https://www.naic.org/): State insurance department directory and consumer insurance guides
- [ISO (Insurance Services Office) Dwelling Program Forms DP-1, DP-2, DP-3](https://www.verisk.com/insurance/brands/iso/): Standard policy language and peril definitions used by most U.S. carriers
- [National Fire Protection Association (NFPA), Structure Fire Data Reports](https://www.nfpa.org/): Annual residential fire loss statistics
...
*Photo: [kazuyoshi sakamoto](https://www.pexels.com/@kazu1000) via Pexels*
