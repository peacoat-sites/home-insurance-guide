---
title: "Home Insurance Exclusions: What Your Policy Won't Cover"
date: 2026-07-28T11:48:27.870683+00:00
draft: false
description: "Discover common home insurance exclusions and gaps in coverage. Learn what damages aren't covered and how to protect your property."
image: "/img/heroes/6471946.jpg"
categories: ["Coverage Basics"]
tags: ["home", "insurance", "exclusions", "list"]
author: "Carl Brooks"
...
slug: "home-insurance-exclusions-list"
affiliate_disclosure: true
faqs:
  - q: "Does homeowners insurance cover water damage from a burst pipe?"
    a: "Generally yes, if the pipe failure was sudden and accidental. Most HO-3 policies cover sudden water damage from plumbing failures. They do not cover damage that developed gradually over time, or damage resulting from lack of maintenance."
  - q: "Is flood damage ever covered under a standard homeowners policy?"
    a: "No. Flood damage from external water sources (storm surge, overflowing rivers, heavy surface runoff) is universally excluded from standard homeowners policies. You need a separate NFIP or private flood policy, and there's typically a 30-day waiting period before coverage takes effect."
  - q: "What does 'ordinance or law' exclusion mean in practice?"
    a: "It means your policy pays to rebuild what you had, not to bring the structure up to current building codes. The gap between those two figures can run into tens of thousands of dollars on older homes. An ordinance or law endorsement covers that difference."
  - q: "Are dog bites covered by homeowners liability?"
    a: "Often yes, but with significant exceptions. Many insurers exclude specific breeds (pit bulls, Rottweilers, Dobermans are common examples) or add surcharges. A bite by an excluded breed can result in a denied liability claim. Check your policy's animal liability language specifically, and ask your agent in writing."
  - q: "Does homeowners insurance cover my home office equipment?"
    a: "Only up to the policy's business property sublimit, which is typically around $2,500. If your equipment is worth more than that, you need either a home-based business endorsement or a separate business owner's policy (BOP). Most standard policies also exclude business liability arising from client visits to your home."
---
...
<div class="kt" style="margin:26px 0;padding:18px 22px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)"><div style="font-size:.72rem;font-weight:700;letter-spacing:.09em;text-transform:uppercase;color:var(--accent,#4338ca);margin-bottom:8px">Key takeaways</div><ul style="margin:0;padding-left:1.15em"><li style="margin:5px 0">Standard HO-3 policies exclude floods, earthquakes, sewer backup, and gradual damage, all four require separate coverage or endorsements.</li><li style="margin:5px 0">Mold claims are routinely denied if the insurer can show the source was a long-term, unaddressed leak rather than sudden water damage.</li><li style="margin:5px 0">"Ordinance or law" exclusions can leave you paying tens of thousands in code-upgrade costs after a covered loss.</li><li style="margin:5px 0">Home-based business equipment is typically capped at $2,500 under standard policies, often a fraction of its actual replacement cost.</li><li style="margin:5px 0">Reviewing your declarations page annually, not just at purchase, is the only way to catch coverage that's drifted out of sync with your actual risk.</li></ul></div>


## The Exclusions That Catch People by Surprise

Flood is the most famous one, and still the most misunderstood. A pipe bursts inside your wall: covered. A river crests and sends three inches of water across your living room: not covered, not even a little, regardless of which insurer you're with. The National Flood Insurance Program (NFIP) exists precisely because private carriers universally exclude flood damage, and the Insurance Information Institute confirms that standard homeowners policies don't cover flooding from external water sources. Yet as of July 2026, roughly 6% of U.S. homeowners carry separate [flood coverage](/home-insurance-flood-coverage/). That number has barely moved in years.
...
Read your policy's exclusions section and you'll find language like "continuous or repeated seepage," "wear and tear," "deterioration," and "latent defect." These phrases collectively do a lot of heavy lifting for [insurance companies](/best-homeowners-insurance-companies/). If your roof has been slowly leaking for two years and the damage finally becomes impossible to ignore, an adjuster is going to look very carefully at whether this was a sudden, accidental loss (potentially covered) or a gradual accumulation (not covered).
...
- [Insurance Information Institute (III)](https://www.iii.org/): Policy structure, standard exclusions, flood and earthquake coverage statistics
- [National Association of Insurance Commissioners (NAIC)](https://www.naic.org/state_web_map.htm): State insurance department contacts and consumer resources
- [Federal Emergency Management Agency (FEMA) / NFIP](https://www.floodsmart.gov/): National flood insurance enrollment rates and policy details
- [California Earthquake Authority](https://www.earthquakeauthority.com/): Earthquake insurance data and pricing for California residents
